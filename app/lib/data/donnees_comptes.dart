...
const comptes = <Compte>[
  ...
  Compte(
    ...
    TypeCompte.createur,
    Color(0xFFB45309),
    'Business plan, banque, marketing',
    verifie: true,
    abonnes: 4200,
    route: '/boutique/mavoungou',
    enCommun: ['Prince B.'],
  ),
  Compte(
    'electro',
    ...
    TypeCompte.organisation,
    Color(0xFF0E7490),
    'Téléphones et électroménager garantis',
    verifie: true,
    abonnes: 5300,
    route: '/boutique/electro',
    enCommun: ['Jordy M.', 'Nadège L.', 'Prince B.'],
  ),
  Compte(
    'ngudi',
    'Mama Ngudi Saveurs',
    TypeCompte.organisation,
    Color(0xFF9D174D),
    'Saka-saka, poisson salé, épices',
    verifie: true,
    abonnes: 8900,
    route: '/boutique/ngudi',
    enCommun: ['Nadège L.'],
    recent: true,
  ),
  Compte(
