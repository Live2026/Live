...
SECTIONS = [
    ...
    ('market', 'Live Market', 'Acheter protégé : l’argent est bloqué par Live jusqu’à la remise, confirmée par QR.', {
        'market_accueil': ('Accueil Market', 'Catégories, boutiques, tendances'),
    ...
    ('vendre', 'Vendre', 'Publier en une minute, accepter, remettre en scannant le QR de l’acheteur, être payé.', {
        ...
        'vendre': ('Vendre un produit', 'Rédaction par Live IA, gain affiché'),
        'annonce_publiee': ('Annonce publiée', 'Une acheteuse commande'),
        'mes_ventes': ('Mes ventes', 'Chiffres clés, commandes par état'),
        ...
        'mes_ventes_bilan': ('Mes ventes, bilan', 'Boost et statistiques en haut'),
        'publier_video': ('Nouvelle vidéo', 'Son, texte, filtres, lien vers une annonce'),
