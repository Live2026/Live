...
SECTIONS = [
    ...
    ('ia', 'Live IA et Live Plus', 'Les produits propres à Live, payés en Crédits Live (1 crédit = 10 FCFA), ou chaque mois avec Live Plus.', {
        ...
        'ia_assistant': ('Assistant Live', 'Accueil nominatif, suggestions, conversations'),
        'ia_assistant_reponse': ('L’assistant agit', 'Réserver la visite, créer l’alerte'),
        'ia_assistant_joindre': ('Joindre un fichier', 'PDF, Word, Excel, PowerPoint, Markdown, image'),
        'ia_assistant_fichier': ('Lire un fichier', 'Prix annoncé en crédits avant la lecture'),
        'ia_assistant_lecture': ('Résumé du document', 'L’essentiel et les points d’attention'),
        'ia_mode_vocal': ('Mode vocal', 'Parler à Live comme au téléphone'),
    ...
    ('quotidien', 'Argent et quotidien', 'Tontines, achats groupés, diaspora et transferts, factures et crédit, Adresse Live, points relais.', {
        ...
        'transfert': ('Live Transfert', 'Envoyer dans sa devise, reçu en FCFA'),
        'transfert_devises': ('Choisir la devise', 'Euro, dollar, livre, yuan… 10 devises'),
        'transfert_dollar': ('Envoi en dollars', 'Taux du jour bloqué 30 minutes'),
        'transfert_recevoir': ('Recevoir de l’étranger', 'Lien de réception, retrait MoMo sans frais'),
    ...
    ('admin', 'Back-office', 'L’outil interne des équipes Live, pensé pour l’ordinateur : vérifications, modération, litiges, finance.', {
        ...
        'admin_quotidien': ('Argent et quotidien', 'Transferts par devise, tontines, factures'),
        'admin_ia': ('Live IA', 'Coût réel par service, limites, refus'),
